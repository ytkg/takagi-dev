...
const REPOS = [
  ...
  'ytkg/commit-genius',
  'ytkg/komeda',
  'ytkg/bundle_outdated_formatter',
  'ytkg/amazon-affiliate-product-selector',
  'ytkg/spotify-workers',
];
...
export default function Home() {
  ...
  return (
    <div className="relative flex justify-center items-center bg-white h-screen -mt-16 -mb-12">
